...
SLIDES = [
    {
        ...
        "narration": "Hi, I'm Becky AI. I'm helping you. Here's what we're going to cover.",
        "lipsync": False,   # set True to overlay a fal.ai lip-synced avatar
    },
    {
        "type": "html",
        "html": "slides/point_one.html",
        "narration": "Point one. Replace this narration with your actual content.",
    },
    {
        "type": "html",
        "html": "slides/outro.html",
        "narration": "Thanks for watching. I was Becky.",
        "lipsync": False,
    },
]
'''
